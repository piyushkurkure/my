...
mongoose.connect("mongodb+srv://piyushkurkure:Hazard@10@piyushshop-sopkz.mongodb.net/test?retryWrites=true&w=majority", {
...
app.listen(PORTNO, () => {
	console.log('Listening on PORTNONO',PORTNO, "\nOpen http://localhost:" + PORTNO, "in the browser");
})
